...
class GuestController extends BaseController implements AuthInterface {
    ...
    public function doLogin()
    {
       ...
       if($validator->passes())
       {
           try
           {
               ...
               {
                    $user = Sentry::authenticateAndRemember($input);
               }
               else
               {
               ...
               if ($user->inGroup($admin)) {
                    ...
                    return Redirect::to('/cso/dashboard');
                }
            } 
    ...
    public function store()
    {
        ...
        if($validator->passes())
        {
            ...
            Mail::queue('pages.email_registration',$data, function($message)
            {
                ...
                $message->to(Input::get('email'),Input::get('first_name').' '.Input::get('last_name'))->subject('Register Account');
            });
